  ...
  return (
    <div className=' w-full'>
      <Head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover, shrink-to-fit=no"></meta>
        ...
        />
         <script async src="https://unpkg.com/pageable@latest/dist/pageable.min.js" crossOrigin="anonymous"></script>
        <script dangerouslySetInnerHTML={{__html: `
        
          new Pageable("#rootcontent", {
            events: {
              mouse: false
            }
          })
      ...
      <Nav></Nav>
      <main id="rootcontent">
      <div className='content top-0 w-full '>
      <header data-anchor="1" className="h-[calc(100vh-72px)] items-center justify-center flex text-center px-2">
        <div>
        ...
        <div className='flex justify-center p-4 mt-[-4rem]'>
      ...
      <div data-anchor="3" className='content flex justify-center items-center py-16 bg-white dark:bg-black h-[100vh]'>
        <div className='container'>
          ...
          <ReactTooltip anchorId="nxjstt" />
          <ReactTooltip anchorId="rjs" />
          <ReactTooltip anchorId="vjs" />
          <ReactTooltip anchorId="js" />
          <ReactTooltip anchorId="ts" />
          <ReactTooltip anchorId="ts" />
          <ReactTooltip anchorId="tailwindcss" />
          <ReactTooltip anchorId="docker" />
          
          <div className='flex grid gap-x-2 sm:grid-cols-10 grid-cols-5 mt-2 items-center'>
            
            <div className='text-2xl p-2 dark:invert'>
              <Image id="nxjstt" alt="Nextjs" data-tooltip-content="Next.JS" src={"/assets/Nextjs.svg"} width={48} height={200}></Image>
            </div>
