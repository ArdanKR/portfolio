...
import { AiFillGithub, AiOutlineEdit, AiOutlineTwitter } from "react-icons/ai";
      ...
      <div className="w-full" ref={containerRef}>
        <div data-anchor="1">
          <header className="h-[calc(100vh-50px)] items-center justify-center flex text-center px-2">
            <div>
              <h1 className="logo font-bold text-5xl">
                <span className={styles.highlightBlue}>Frontend</span> &{" "}
                <span className={styles.highlight}>UI/UX</span> Developer
              </h1>
              <p className="mt-4">
                <span className="logo font-semibold">Sanghyuk Park</span>
                {"'"}s Portfolio
              </p>
            </div>
            <div className="z-[-1] absolute blur-xl select-none px-2">
              <h1 className="logo font-bold text-5xl text-white dark:text-black">
                <span className={styles.highlightBlue}>Frontend</span> &{" "}
                <span className={styles.highlight}>UI/UX</span> Developer
              </h1>
              <p className="mt-4">
                <span className="logo font-semibold text-white dark:text-black">
                  Sanghyuk Park
                </span>
                {"'"}s Portfolio
              </p>
            ...
            <Link href="#2">
              ...
              >
                ...
                <g clipPath="url(#__lottie_element_167)">
                  <g
                    transform="matrix(0.3134399950504303,0,0,0.3134399950504303,11.139762878417969,46.2999382019043)"
                    opacity="1"
                  >
                    <path
                      fill="#cccccc"
        ...
        <div
          data-anchor="2"
          className="content flex justify-center items-center py-16 bg-slate-100 dark:bg-black h-[100vh]"
        >
          <div className="container">
            <h1 className="logo font-bold text-3xl sm:text-5xl">
              👋 Hi, there
            </h1>
            <p className="mt-4">
              I{"'"}m <span className="marker">Sanghyuk Park</span>, a high
              school student developer from South Korea.
            </p>
            <div className="flex gap-x-2 mt-2">
              <Link
                href="https://github.com/ardankr"
                data-href="https://github.com/ardankr"
                className="doclink text-2xl shadow-md flex rounded-full dark:bg-black bg-white p-1 cursor-pointer"
              >
                <AiFillGithub></AiFillGithub>
              </Link>

              <Link
                href="https://twitter.com/kr_ardan"
                data-href="https://twitter.com/kr_ardan"
                className="doclink text-2xl shadow-md flex rounded-full dark:bg-black bg-white p-1 cursor-pointer text-[#1d9bf0]"
              >
                <AiOutlineTwitter></AiOutlineTwitter>
              </Link>
              <Link
                href="https://blog.ardan.kr/"
                data-href="https://blog.ardan.kr/"
                className="doclink text-2xl shadow-md flex rounded-full dark:bg-black bg-white p-1 cursor-pointer"
              >
        ...
        <div
          data-anchor="3"
          className="content flex justify-center items-center py-16 bg-white dark:bg-black h-[100vh]"
        >
          <div className="container">
            <h1 className="logo font-bold text-3xl sm:text-5xl">Tech Stacks</h1>
            <p className="mt-4">
              These are the techniques I use. This also includes what I am
              learning.
            </p>
            ...
            <div className="grid gap-x-2 sm:grid-cols-10 grid-cols-5 mt-2 items-center">
              ...
              <div className="text-2xl p-2">
                <Image
                  id="docker"
                  alt="Docker"
                  data-tooltip-content="Docker(Learning)"
        ...
        >
          <div className="container">
            ...
            <ul className="mt-4">
              <li>
                <span className="logo">DevHub</span> ─ Founder, CEO (2019~2020)
                (Disbanded)
              </li>
              <li>
                <span className="logo">HKDev Korea</span> ─ Head of Developer
                (2020.10.24~2022.12.12) (Resigned)
              </li>
              <li>
                <span className="logo">HKDev Korea</span> ─ Web Developer
                (2020.10.24~2023.02.02) (Resigned)
              </li>
              <li>
                <span className="logo">Pluxcon Network</span> ─ Web Developer
                (2021~)
              </li>
              <li>
                <span className="logo">Team Deplux</span> ─ Web Developer
                (2021~) (Paused)
              </li>
            </ul>
          </div>
        ...
        >
          <div className="container">
            ...
            <ul className="mt-4">
              <li>
                <span className="logo">Portfolio</span>: My Portfolio Project.
                (TailwindCSS, Next.JS, TypeScript)
              </li>
              <li>
                <span className="logo">Deplux</span>: Discord Bot Hosting
              </li>
              <li>
                <span className="logo">MarioMaker2 Search</span>: This is a
                Discord bot that helps you search for Mario Maker 2 courses.
                (Node.JS, Discord.JS)
              </li>
            </ul>
          </div>
        ...
        <div
          data-anchor="6"
          className="content flex justify-center items-center py-16 bg-white dark:bg-black h-[100vh] flex-col"
        >
          <div className="container h-[50%] flex items-end">
            <div>
              ...
              <ul className="mt-4">
                <li>
                  📬 <span className="logo">Email</span>:{" "}
                  <span className="underline">
                    <Link
                      data-href={"mailto:contact@ardan.kr"}
                      href={"mailto:contact@ardan.kr"}
                    >
                      contact@ardan.kr
                    </Link>
                  </span>
          ...
          <div className="container h-[50%] flex items-end text-center justify-center">
            <Link
              className="doclink"
              data-href="https://github.com/ArdanKR/portfolio"
              href="https://github.com/ArdanKR/portfolio"
              target={"_blank"}
            >
              Made with <span className="text-[#f8312f]">♥️</span> by Sanghyuk
              Park.
            </Link>
          </div>
        </div>
